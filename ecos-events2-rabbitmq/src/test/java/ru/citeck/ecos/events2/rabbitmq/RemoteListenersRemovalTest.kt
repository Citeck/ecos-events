...
class RemoteListenersRemovalTest {
    ...
    fun setUp() {
        ...
        eventServiceEmitterApp1 = TestUtils.createApp("app1", connection, ecosZooKeeper, mapOf(
            Pair(personIvanRecordRef, personIvanRecord)
        ))

        eventServiceReceiverApp0 = TestUtils.createApp("app_rec_0", connection, ecosZooKeeper, emptyMap())
        eventServiceReceiverApp1 = TestUtils.createApp("app_rec_1", connection, ecosZooKeeper, emptyMap())
        eventServiceReceiverApp2 = TestUtils.createApp("app_rec_2", connection, ecosZooKeeper, emptyMap())
    }
